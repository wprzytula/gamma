 ...
 */
static int32_t calculate_player_adj_free_fields_change(
 ...
 */
static int32_t calculate_new_owner_occ_areas_change(gamma_t *g,
 ...
 */
static int32_t calculate_former_owner_occ_areas_change(gamma_t *g,
